...
// CompanySettingsView's Actions section. See users/service.py for why
// deactivation is its own endpoint with its own re-auth gate rather
// than folded into UserUpdate.
// ---------------------------------------------------------------------------
