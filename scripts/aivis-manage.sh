...
reload_bound_profile() {
    ...
    echo "  (malformed types.yaml, one of the three msg.* chat types"
    echo "  declared without a category, ANY type declared with an empty"
    echo "  or over-long one, a broken template placeholder)."
    echo ""
