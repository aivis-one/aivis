# =============================================================================
# AIVIS.ONE Backend -- Database Connection
# =============================================================================
#
# LAZY ENGINE:
...
#   Explicit commit in router = double commit = InvalidRequestError.
#   In routers: use flush() + refresh() to get DB-generated values.
# =============================================================================
...
async def get_db_session() -> AsyncGenerator[AsyncSession, None]:
    ...
    Use for all write operations. Never call session.commit() in routers --
    this generator handles the single commit automatically.
    """
...
async def get_db_reader() -> AsyncGenerator[AsyncSession, None]:
    ...
    Use for GET endpoints that do not modify any data.
    """
    factory = get_session_factory()
    session = factory()
    try:
