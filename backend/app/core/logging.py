...
#
# LOG LEVEL FILTERING:
#   make_filtering_bound_logger drops events below the configured level
#   at the binding stage -- before any processor runs. Much more efficient
#   than stdlib filtering which processes the event first.
#
